 ...
 *
 *	 ./node_modules/start-react-tools/scripts/build.js
 *	 ./node_modules/start-react-tools/scripts/start.js
 *	 ./scripts/start.js
 *
 * It should return:
 *
 *	 findScript('build') => './node_modules/start-react-tools/scripts/build.js'
...
const findConfig = (() => {
	...
	return () => {
		...
		const webpackConfig = process.env.NODE_ENV === 'development' ?
			require('./scripts/webpack-dev.config') :
			require('./scripts/webpack-prod.config');
